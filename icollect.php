...
<body>
	...
	<div class="container-fluid">
		<div class="jumbotron" id="managecollection">
			...
			<p>
				<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#compositionCreation" aria-expanded="false" aria-controls="compositionCreation">
					Show enter a new composition form
				</button>
			  <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collectionCreation" aria-expanded="false" aria-controls="collectionCreation">
			    Show create a new collection form
			  </button>
			</p>

			<div class="card collapse" id="compositionCreation">
				<h5 class="card-title">Enter a composition</h5>
				<div class="card-body">
					<?php  displayEnterCompositionForm();  ?>
				</div>
			</div>

			<div class="card collapse" id="collectionCreation">
				<h5 class="card-title">Create a new collection of reactions to a composition.  Enter the composition first.</h5>
			  <div class="card-body">
					<?php  displayCreateCollectionForm();  ?>
			  </div>
			</div>
